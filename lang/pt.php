   ...
   // Name: pt.php
    $lang = array (
       ...
       //"String" => "Translated String",
        ...
        "academic-type-1" => "Intercâmbio",
        "academic-title-1" => "INGLÊS AVANÇADO",
        "academic-place-1" => "Delfin School",
        "academic-content-1" => "Intercâmbio internacional em Dublin - Irlanda. Curso intensivo de inglês avançado.",
        "academic-year-2" => "2014",
        "academic-type-2" => "Graduação",
        "academic-title-2" => "ENGENHARIA DA COMPUTAÇÃO",
        "academic-place-2" => "Unifieo",
        "academic-content-2" => "Ensino superior em Engenharia da Computação no centro universitário FIEO.",
