   ...
   // Name: pt.php
    $lang = array (
       ...
       //"String" => "Translated String",
        ...
        "projects-detail-1" => "Esse foi o primeiro app desenvolvido em React Native na Natura. Depois do lançamento expandimos a jornada para Latam. Como responsável pela jornada estive presencialmente para representar o time no lançamento em alguns lugares como Natal (Brasil) e Punta Cana (Rep. Dom).",
        "projects-name-2" => "Site Natura",
        "projects-title-2" => "Product Owner",
        "projects-detail-2" => "Website oficial da Natura (www.natura.com.br).",
        "projects-name-3" => "App Thunt",
        "projects-title-3" => "Idealizador e developer",
        "projects-detail-3" => "App para publicidade de promoções utilizando geolocalização indoor para shoppings e galerias.",
        "projects-name-4" => "Themis",
        "projects-title-4" => "Developer",
        "projects-detail-4" => "Trabalhei com desenvolvimento Java Web no backoffice da solução para departamentos jurídicos.",
        "projects-name-5" => "App Colaborador Natura",
        "projects-title-5" => "Product Owner",
        "projects-detail-5" => "Construímos um app para facilitar o dia a dia dos colaboradores da Natura. Meu papel era ter um olhar de produto para o app e ajudar a priorizar o que traria mais valor de negócio para o público.",
        "projects-name-6" => "FAQ",
        "projects-title-6" => "Product Owner",
        "projects-detail-6" => "---",
        "projects-name-7" => "Start55",
        "projects-title-7" => "Idealizador e CTO",
        "projects-detail-7" => "Solução de apoio e aceleração ao empreendedorismo para pessoas maduras.",
        "projects-name-8" => "Convergência",
        "projects-title-8" => "Scrum Master",
        "projects-detail-8" => "A Natura estava num momento de unificar seus modelos de negócio digital e presencial, por isso apelidamos de progama 'Convergencia'. Estive a frente do serviço de atração e boas vindas, onde desenvolvemos um pacote de melhorias nas ferramentas de cadastro e relatórios para nossa força de vendas. ",
        ...
        "projects-detail-11" => "Desenvolvemos uma inteligencia capaz de interagir com clientes com respostas inteligentes e com linguagem natural e, com o passar do tempo, implementamos novas funcionalidades para automatizar alguns serviços.",
        "projects-name-12" => "MasterChef Agile",
        "projects-title-12" => "Idealizador e Facilitador",
        "projects-detail-12" => "Fui convidado para falar em um evento sobre Agilidade. Propus fazer uma dinamica diferente onde, através de montagem de pizzas, aplicamos conceitos de agilidade simulando um dia a dia de um time real. No final o time que fizesse as melhores pizzas ganhavao 'Masterchef' ;-)",
